        ...
        if Location == s:
            ...
            if a == 1:
                if 'Tire' not in inventory:
                    ...
                    print('You go inside, and grab a tire.')
                    inventory.append('Tire')
                else:
                     print('You have already been here, it is looted.')
            elif a == 2:
                if 'Wrench' not in inventory:
                    print('You once visited this place to check your car\'s tires and it is O-Riely Atuoparts. You stand outside it wondering if you could use anything from in there for your car.')
                    print('You go inside, and grab a wrench.')
                ...
                if 'Pills' not in inventory:
                    print('You are standing outside a white building with a red cross, a Hospital, preparing to go inside and loot it for med kits.')
                    print('You run inside, and nab a bottle of pills.')
                ...
                if 'Water' not in inventory:
                    ...
                    print('You hustle inside, and steal some Water.')
                ...
                if 'Gun' not in inventory:
                    ...
                    print('You find a gun with ammo amoungst the plie, and test it on a zombie nearby then store it for safe keeping.')
                    inventory.append('Gun')
                else:
                    print('You have already been here, it is looted of useable weapons.')
            elif a == 8:
